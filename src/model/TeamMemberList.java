...
public class TeamMemberList
{
	...
	public TeamMemberList() { this.teamMemberList = new ArrayList<>(); }

	public void add(TeamMember teamMember) { teamMemberList.add(teamMember); }

	public void remove(TeamMember teamMember) { teamMemberList.remove(teamMember); }
