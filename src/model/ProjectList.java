...
//    }
    ...
    this.idIndex = Integer
        .parseInt(projectList.get(projectList.size() - 1).getId() + 1);
  }
  ...
  @Override public boolean equals(Object obj)
  {
    ...
    if (idIndex != other.idIndex || projectList == null
        || projectList.size() != other.getSize())
      return false;
    for (int i = 0; i < projectList.size(); i++)
    {
      if (!projectList.get(i).equals(other.getProject(i)))
        return false;
    }
  ...
  @Override public String toString()
  {
    ...
    {
      s += project.getId() + "    " + project.getTitle() + "    " + project
          .getStatus() + "\n";
      ...
      for (int i = 0; i < requirementList.getSize(); i++)
      {
        ...
        s +=
            req.getId() + "   " + req.getUserStory() + "   " + req.getDeadline()
                + "   " + req.getResponsiblePerson().getName() + "   " + req
                .getStatus() + "\n";
        ...
        for (int j = 0; j < taskList.getSize(); j++)
        {
          ...
          s += task.getId() + "   " + task.getTitle() + "   " + task
              .getDeadline() + "   " + task.getResponsiblePerson().getName()
              + "    " + task.getStatus() + "\n";
        }
      }
    }
