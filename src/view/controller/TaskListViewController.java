...
public class TaskListViewController
{
  ...
  private void update()
  {
    ...
    responsiblePersonComboBox.setValue(model
        .getResponsiblePersonForRequirement(state.getSelectedProjectID(),
            state.getSelectedRequirementID()).getName());
  ...
  private void addComboBoxItems()
  {
    ...
    if (responsiblePersonComboBox.getItems().size() == 0)
    {
      ...
      if (teamMemberList.size() != 0)
        responsiblePersonComboBox.getItems().removeAll(teamMemberList);
    }
  }
  ...
  @FXML public void handleChooseTeamMemberButton()
  {
